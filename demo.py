...
# for j in range(numD2D-1):
#     tbs, rb = tool.data_tbs_mapping(data[j], 1)
#     cqi = convert.TBS_CQI_mapping(tbs)
#     sinr = convert.CQI_SINR_mapping(cqi)
#     minSinr = convert.dB_to_mW(sinr)
#     i = background * g_d2d[3][j][0][0]
#     power = (minSinr * (N0 + i)) / g_d[j][0][0]
#     powerDB = convert.mW_to_dB(power*1000)

#     print('minSINR',sinr)
#     print('minPower',powerDB)
#     s = (power * g_d[j][0][0]) / (N0 + i)
#     print('sinr',convert.mW_to_dB(s))
#     print()
...
# minSinr = convert.dB_to_mW(sinr)
# i = background * g_d
# power = (minSinr * (N0 + i)) / g_d

# print(power)
# powerDB = convert.mW_to_dB(power*1000)
# print(powerDB)
# s = (power * g_d) / (N0 + i)
# print(convert.mW_to_dB(s))
# print()
