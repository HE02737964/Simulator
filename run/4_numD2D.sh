...
cd .. && python3  simulation.py method 500 numD2D 80 config &
cd .. && python3  simulation.py method 500 numD2D 85 config &
cd .. && python3  simulation.py method 500 numD2D 90 config &
cd .. && python3  simulation.py method 500 numD2D 95 config &
...
cd .. && python3  simulation.py juad 500 numD2D 80 config &
cd .. && python3  simulation.py juad 500 numD2D 85 config &
cd .. && python3  simulation.py juad 500 numD2D 90 config &
cd .. && python3  simulation.py juad 500 numD2D 95 config &
...
cd .. && python3  simulation.py gcrs 500 numD2D 80 config &
cd .. && python3  simulation.py gcrs 500 numD2D 85 config &
cd .. && python3  simulation.py gcrs 500 numD2D 90 config &
cd .. && python3  simulation.py gcrs 500 numD2D 95 config &
...
cd .. && python3  simulation.py greedy 500 numD2D 80 config &
cd .. && python3  simulation.py greedy 500 numD2D 85 config &
cd .. && python3  simulation.py greedy 500 numD2D 90 config &
cd .. && python3  simulation.py greedy 500 numD2D 95 config &